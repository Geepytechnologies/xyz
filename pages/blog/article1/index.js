...
export default function Index() {
    const Article = () => (
        <div className='p-[20px]'>
            ...
            <Image src={'/article1.png'} fill={true} style={{objectFit: 'contain', objectPosition: 'center'}} />
            </div>
            ...
            <div className='w-[300px] md:w-[500px] h-[300px] relative '>
                <Image alt='' src={'/article101.png'} fill={true} style={{objectFit: 'contain', objectPosition: 'center'}} />
            </div>
